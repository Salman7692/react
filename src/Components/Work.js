...
export default function Home() {
  ...
  return (
    ...
    <Box>
      <div className="bo">
        <div className="content"><Typography sx={{fontFamily:"'Times New Roman', Times, serif", fontWeight:"bold",fontSize:"62px"}}  variant="h3">You Are At Best Place To Work</Typography>
